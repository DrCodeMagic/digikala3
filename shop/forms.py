    ...
    new_password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={
                ...
                'name':'password',
                'type':'password',
                'placeholder':'رمزبالای 8کاراکتر را وارد کنید'
            }
        )
    )
...
class UpdateUserForm(UserChangeForm):
    ...
    first_name = forms.CharField(
        label="",
        max_length=50,
        widget=forms.TextInput(attrs={'class':'form-control','placeholder':'نام خودراواردکنید'})
        ,required=False
    )
    last_name = forms.CharField(
        label="",
        max_length=50,
        widget=forms.TextInput(attrs={'class':'form-control','placeholder':'نام خانوادگی خودراواردکنید'})
        ,required=False
    )
    email = forms.EmailField(
        label="",
        
        widget=forms.TextInput(attrs={'class':'form-control','placeholder':'ایمیل خودراواردکنید'})
        ,required=False
    )
