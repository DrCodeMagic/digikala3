...
def user_orders(request):
    if request.user.is_authenticated:
        ...
        messages.success(request, 'دسترسی به این صفحه امکان پذیرنمیباشد')
        return redirect('home')
...
def update_info(request):
    if request.user.is_authenticated:
        ...
        messages.success(request,'ابتدا باید لاگین شد')
        return redirect('home')
        ...
        if user is not None:
            ...
            if saved_cart:
                try:
                    ...
                    messages.success(request,"پروفایل شما با موفقیت وارد شد")
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("update_info")
               ...
               messages.success(request,('مشکلی در ثبت نام شماوجود دارد'))
...
def update_user(request):
    if request.user.is_authenticated:
        ...
        messages.success(request,'ابتدا باید لاگین شود')
        return redirect('home')
...
def update_password(request):
    if request.user.is_authenticated:
        ...
        messages.success(request,'اول باید لاگین کنید!')
        return redirect('home')
